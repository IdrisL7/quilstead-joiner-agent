...
| Keyboard order | nav, start date, recalculate, demo controls, candidate rows, actions; `:focus-visible` outline on all controls, white outline in the sidebar independent of the coral selection marker |
